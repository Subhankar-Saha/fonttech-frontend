...
export class AllPermissions implements IGateIn, ILocateContainer, IContainerMovement, ITask, IYardPlanning,
	IMachines, IGateInOutReport, IContainerReport, IMachineReport, ITrailers, IGateOut, IOrganizationConfiguration,
	IFreightStationConfiguration, IRoleConfiguration, IUserConfiguration, IMachineConfiguration, IDeviceConfiguration {
