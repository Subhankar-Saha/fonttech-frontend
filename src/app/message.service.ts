...
export class MessageService {
  ...
  public static readonly GENERIC_FAILURE_REQUEST_INCOMPLETE: string =
  ...
  public static readonly WRONG_CREDENTIAL_ERROR: string =
    "Please check your credentials!";
  public static readonly EXPIRED_TOKEN_RECEIVED: string =
    "An expired session was received. You may need to login again.";
